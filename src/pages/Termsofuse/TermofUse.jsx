  ...
  return (
    <>
      <div className={styles.container}>
        <h2 className={styles.heading}>Website Terms of Use</h2>
        <p>Version 1.0</p>
        <p>
          The 10015 Tools website located at https://10015.io is a copyrighted
          work belonging to 10015 Tools. Certain features of the Site may be
        ...
        <div>
          <h2 className={styles.heading}>Access to the Site</h2>
          <p>
            {" "}
        ...
        <div>
          <h2 className={styles.heading}>User Content</h2>
          <p>
        ...
        <div>
          <h2 className={styles.heading}>Third-Party Links & Ads; Other Users</h2>
          <p>
          ...
          <p>
            <b>Other Users.</b> Each Site user is solely responsible for any and
            all of its own User Content. Because we do not control User Content,
          ...
          <p>
            <b>Google DoubleClick DART Cookie.</b> Google is one of a
          ...
          <p>
            <b>Our Advertising Partners.</b> Some of advertisers on our site may
            use cookies and web beacons. Our advertising partners are listed
            below. Each of our advertising partners has their own Privacy Policy
            for their policies on user data. For easier access, we hyperlinked
        ...
        <div>
          <h2 className={styles.heading}>Limitation on Liability</h2>
          <p>
          ...
          <p>
            <b>Term and Termination.</b> Subject to this Section, these Terms
        ...
        <div>
          ...
          <p>
            ...
            to permit us to locate such material; your address, telephone
            number, and e-mail address; a statement that you have a good faith
            belief that use of the objectionable material is not authorized by
            the copyright owner, its agent, or under the law; and a statement
            that the information in the notification is accurate, and under
            penalty of perjury, that you are either the owner of the copyright
            that has allegedly been infringed or that you are authorized to act
            on behalf of the copyright owner. Please note that, pursuant to 17
        ...
        <div>
          ...
          <p>
            <b>Copyright/Trademark Information.</b> Copyright ©. All rights
