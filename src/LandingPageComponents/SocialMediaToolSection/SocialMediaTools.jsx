...
const SocialMediaTools = () => {
  ...
  return (
    <section id="social-media-tools" className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
      <h1 className="text-3xl sm:text-4xl font-semibold text-gray-900 mb-6">Social Media Tools</h1>
      ...
      <div ref={cardsRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
        {socialTools.length > 0 ? (
          ...
          <p className="col-span-full text-center text-gray-500">No social media tools found.</p>
        )}
      </div>
    </section>
  );
