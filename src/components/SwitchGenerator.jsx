    ...
    return (
        <div className="max-w-5xl mx-auto min-h-screen bg-gray-50 font-manrope">
            ...
            <div className="flex justify-between items-center mb-8">
                {/* Optional: Add a Color Picker here if you want to change colors globally */}
                ...
                <p className="text-slate-500 text-sm font-semibold tracking-wide">
                    Total CSS Checkbox Count: <span className="text-indigo-900 font-bold">{toggleSwitchDesigns.length}</span>
                </p>
            </div>
